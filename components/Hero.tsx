  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[#09090b] text-white font-sans">
      ...
      <AnimatePresence initial={false} custom={direction} mode="popLayout">
        ...
        >
          {/* High Res Background - will-change for smooth GPU compositing */}
          <div
            className="absolute inset-0 bg-cover bg-top"
            style={{ backgroundImage: `url(${movie.backdropUrl})`, willChange: 'opacity' }}
          />
          ...
          {/* Gold Glow Accent - lightweight gradient instead of GPU-intensive blur */}
          <div className="absolute top-0 left-0 w-[40vw] h-[40vh] bg-gradient-to-br from-yellow-600/8 to-transparent pointer-events-none" />
        </motion.div>
      </AnimatePresence>
